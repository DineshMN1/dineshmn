...
**ExampleSite** can be found here: [**exampleSite**](https://github.com/adityatelange/hugo-PaperMod/tree/exampleSite). Demo is built up with [exampleSite](https://github.com/adityatelange/hugo-PaperMod/tree/exampleSite) as the source.
...
-   Light/Dark theme (automatic theme switch according to browser theme and theme-switch button).
-   SEO Friendly.
...
-   No webpack, nodejs, or other dependencies are required to edit the theme.
...
Check out my repository for the code and updates: [**DineshMN1/dineshmn**](https://github.com/DineshMN1/dineshmn.git)

## Live Website

Visit my live website: [**dineshmn.vercel.app**](https://dineshmn.vercel.app)
